...
import id.ac.umn.R;
import id.ac.umn.model.HistoryModel;
import id.ac.umn.adapter.HistoryAdapter;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    String id_book = "", mobil, tujuan, tanggal, lama, riwayat, total;
    String email;
    TextView tvNotFound;
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            mobil = cursor.getString(1);
            tujuan = cursor.getString(2);
            tanggal = cursor.getString(3);
            lama = cursor.getString(4);
            total = cursor.getString(10);
            riwayat = "Berhasil melakukan booking untuk mobil " + mobil + " di kota " + tujuan + " pada tanggal " + tanggal + ". "
                    +"Durasi penyewaan adalah " + lama + " hari.";
