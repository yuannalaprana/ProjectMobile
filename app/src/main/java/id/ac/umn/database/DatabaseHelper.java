...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String COL_LAMA = "lama";
    public static final String TABLE_HARGA = "tb_harga";
    public static final String COL_HARGA_LAMA = "harga_lama";
